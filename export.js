...
// "Mastered" is generated by the app from each activity's status, unlike the
// section headings the user writes themselves. Giving it a green band says
// which of the two a reader is looking at without needing a legend.
const sectionBandFill = label => (label === "Mastered" ? "#dcfce7" : "#e5e7eb");
const sectionBandText = label => (label === "Mastered" ? "#166534" : "#374151");
